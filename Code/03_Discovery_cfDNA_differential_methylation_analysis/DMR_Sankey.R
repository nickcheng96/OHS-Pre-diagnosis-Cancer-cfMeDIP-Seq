...
#loading annotation + dmr files
cpg.window.annotated = readRDS('genomic.annotations.window.300.RDS')
...
#functions use for reformatting DMR tables for sankey plotting
...
for (sex in c('Male','Female')) {
  ...
  #formatting top DMRs for sankey plot
